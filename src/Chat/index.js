...
useEffect(() => {
  var element = document.querySelector(".my-col");
  element.style.backgroundColor = profile.primary_color;
...
console.log(profile)
  ...
  return (
    <div className=' h-screen w-screen flex bg-[profile.primary_color] my-col'>
          ...
          chat.length > 0 ?
            ...
            (
              <div className=' h-[80%] flex flex-col justify-center items-center text-white'>
                <div className=' text-4xl font-bold mb-8'>Bot</div>
